import { DocumentItem, DocumentSourceCitation, RecentChat, ChatMessage } from '../types';

export const INITIAL_CITATIONS: DocumentSourceCitation[] = [
  {
    id: 'cite-fw-1',
    page: 2,
    label: 'Page 2',
        ...
        sections: [
          {
            ...
            paragraphs: [
              'Vector Indexing (HNSW, ScaNN, Milvus, Pinecone), Large Language Model Grounding, TypeScript, Python, PyTorch, Distributed Systems, High-throughput Inference Pipelines.',
            ],
          },
        ],
      },
