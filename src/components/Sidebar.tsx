...
import { RecentChat, AuthUser } from '../types';
import {
  Plus,
  MessageCircle,
  Trash2,
...
/**
 * DocLens Navigation Sidebar
 * 
 * Clean, document-focused navigation:
 * - "+ New Chat" button at top
 * - Chronological conversation history with message circle icons
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-[260px] shrink-0 h-screen flex flex-col justify-between select-none bg-[#f9f9f9] dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 text-neutral-900 dark:text-neutral-100 z-30 transition-colors duration-200">
      {/* Top Header & New Chat */}
          ...
          <>
            ...
            <div>
              ...
              <div className="space-y-0.5 mt-1">
                {todayChats.length === 0 ? (
                  <div className="px-2 py-2 text-xs text-neutral-400 dark:text-neutral-500 italic">No chats today</div>
                ) : (
                  todayChats.map((chat) => {
