...
export const LeftRail = ({
  ...
  return <aside className="w-16 shrink-0 flex flex-col items-center justify-between py-6 select-none">
      {
    /* Top Action Icons */
  }
  ...
  >
    ...
    className={`w-10 h-10 rounded-full border flex items-center justify-center transition-all cursor-pointer shadow-xs group ${currentView === "documents" || currentView === "upload" ? "bg-[#15271a] border-[#22c55e] text-[#4ade80] shadow-[0_0_12px_rgba(34,197,94,0.3)]" : "bg-[#0d1610] border-[#1b2b20] hover:border-[#22c55e]/50 hover:bg-[#142618] text-neutral-400 hover:text-[#4ade80]"}`}
  >
    ...
    className={`w-10 h-10 rounded-full border flex items-center justify-center transition-all cursor-pointer shadow-xs group ${currentView === "split" ? "bg-[#15271a] border-[#22c55e] text-[#4ade80] shadow-[0_0_12px_rgba(34,197,94,0.3)]" : "bg-[#0d1610] border-[#1b2b20] hover:border-[#22c55e]/50 hover:bg-[#142618] text-neutral-400 hover:text-[#4ade80]"}`}
  >
