...
/**
 * DocumentHistoryModal Component
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border transition-all ${
                    isActive
                      ? 'border-neutral-900/30 dark:border-neutral-700 bg-neutral-50/70 dark:bg-neutral-850 shadow-2xs'
                      : 'border-neutral-200/80 dark:border-neutral-800 bg-white dark:bg-neutral-850 hover:border-neutral-300 dark:hover:border-neutral-700'
                  }`}
                >
                    ...
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          {isActive && (
                            <span className="flex items-center gap-1 text-[10px] font-medium text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 px-2 py-0.5 rounded-full">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <button
                        ...
                        className={`flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg transition-colors cursor-pointer ${
                          isActive
                            ? 'bg-neutral-200/70 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200'
                  ...
                  {isExpanded && (
                    <div className="px-4 pb-3.5 pt-1 border-t border-neutral-100 dark:border-neutral-800 text-xs text-neutral-600 dark:text-neutral-300 bg-neutral-50/40 dark:bg-neutral-900/60 rounded-b-xl space-y-2">
                      {doc.summary && (
                        <div>
                      ...
                      <div className="flex items-center justify-between pt-1 text-[11px] text-neutral-400 dark:text-neutral-500">
                        <span className="flex items-center gap-1">
                          ...
                          Parsed Chunks: {doc.chunks || Math.max(1, Math.round((doc.rawText?.length || 1000) / 1000))}
                        </span>
                        <button
                          onClick={() => {
                            onSelectDocumentForChat(doc);
