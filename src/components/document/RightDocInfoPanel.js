...
export const RightDocInfoPanel = ({
  document,
  citations,
  onSelectCitation,
  activeCitationId,
  ...
  return <aside className="w-[340px] shrink-0 h-full border-l border-neutral-200/80 bg-white flex flex-col justify-between overflow-y-auto select-none">
  ...
  >
    ...
    /* DOCUMENT Section */
        ...
        <div>
          ...
          <div className="p-3 rounded-xl bg-neutral-50 border border-neutral-200/70">
            ...
            {document.summary && <p className="mt-2.5 text-xs text-neutral-600 line-clamp-2 leading-relaxed">
                {document.summary}
              </p>}
          </div>
        </div>
    ...
    return <div
      ...
      className={`p-3 rounded-xl border text-left transition-all cursor-pointer group ${isSelected ? "border-neutral-900 bg-neutral-100 ring-1 ring-neutral-900" : "border-neutral-200/80 bg-white hover:border-neutral-300 hover:bg-neutral-50/60"}`}
    >
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-1.5">
                      ...
                      {cite.sectionTitle && <span className="text-[11px] text-neutral-500 truncate max-w-[170px]" title={cite.sectionTitle}>
                          {cite.sectionTitle}
                        </span>}
                    </div>
    ...
    /* Bottom Action: Split View reader */
      ...
      {onOpenSplitView && <div className="p-3 border-t border-neutral-200/80 bg-neutral-50/80">
          <button
