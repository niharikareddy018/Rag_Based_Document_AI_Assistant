...
/**
 * Top Header with Document History Counter in Center, New Chat and Dark Mode Toggle
 * 
 * - Left: Menu toggle + DocLens Title
 * - Center: Document History counter pill with uploaded document count
 * - Right: New Chat button before Screen Mode Toggle
 */
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="relative h-13 px-4 flex items-center justify-between shrink-0 select-none bg-white dark:bg-neutral-900 border-b border-neutral-200/70 dark:border-neutral-800 text-neutral-900 dark:text-neutral-100 z-10 transition-colors">
