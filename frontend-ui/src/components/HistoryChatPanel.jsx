...
export const HistoryChatPanel = ({
  ...
  return <aside className="w-[310px] shrink-0 h-full rounded-3xl bg-[#0c140e]/90 border border-[#1b2c20] p-5 shadow-2xl backdrop-blur-xl flex flex-col justify-between overflow-hidden select-none">
      {
    /* Top Header */
  }
  ...
  >
    ...
    return <div key={group.label} className="space-y-2">
      ...
      return <div
        ...
        className={`w-full group relative flex items-center justify-between px-3.5 py-2.5 rounded-2xl border transition-all cursor-pointer text-left ${isActive ? "bg-[#142618] border-[#22c55e] text-white shadow-[0_0_15px_rgba(34,197,94,0.15)]" : "bg-[#0e1710]/70 border-[#19281d] hover:border-[#28422e] hover:bg-[#121f15] text-neutral-300"}`}
      >
                      <div className="flex items-center gap-2.5 min-w-0 pr-2">
                        <MessageSquare
        className={`w-4 h-4 shrink-0 transition-colors ${isActive ? "text-[#4ade80]" : "text-neutral-500 group-hover:text-neutral-300"}`}
      />
