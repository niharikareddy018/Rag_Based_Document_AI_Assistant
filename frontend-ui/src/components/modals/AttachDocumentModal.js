...
export const AttachDocumentModal = ({
  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-in fade-in">
      <div
  ...
  >
    ...
    className={`border-2 border-dashed rounded-xl p-5 text-center transition-all cursor-pointer ${isDragging ? "border-neutral-900 bg-neutral-50" : "border-neutral-300 hover:border-neutral-400 bg-neutral-50/50"}`}
  >
            <input
    type="file"
  ...
  />
    ...
    return <button
      ...
      className={`w-full flex items-center justify-between p-3 rounded-xl border text-left transition-all cursor-pointer ${isSelected ? "bg-neutral-100 border-neutral-400 shadow-2xs" : "bg-white border-neutral-200 hover:border-neutral-300 hover:bg-neutral-50"}`}
    >
                    ...
                    {isSelected && <div className="w-5 h-5 rounded-full bg-neutral-900 text-white flex items-center justify-center shrink-0">
