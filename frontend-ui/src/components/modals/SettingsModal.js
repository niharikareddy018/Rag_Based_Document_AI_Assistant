...
export const SettingsModal = ({
  ...
  >
    ...
    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer shadow-2xs ${isConfirming ? "bg-red-600 hover:bg-red-700 text-white animate-pulse" : "bg-red-50 dark:bg-red-950/40 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/40 border border-red-200 dark:border-red-900/60"}`}
  >
