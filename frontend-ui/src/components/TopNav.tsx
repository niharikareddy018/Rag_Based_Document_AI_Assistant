...
export const TopNav: React.FC<TopNavProps> = ({
  ...
  return (
    <header className="w-full flex items-center justify-between px-6 py-3 select-none">
      {/* 1. Left Brand Icon */}
      ...
      <div className="flex items-center p-1 rounded-full bg-[#0b130e]/90 border border-[#1b2c20] shadow-xl backdrop-blur-md">
        <button
          ...
          className={`px-5 py-2 rounded-full text-xs sm:text-sm font-medium transition-all cursor-pointer ${
            currentView === 'dashboard'
              ? 'bg-[#15271a] text-[#4ade80] border border-[#22c55e]/40 shadow-xs'
        ...
        <button
          ...
          className={`px-5 py-2 rounded-full text-xs sm:text-sm font-medium transition-all cursor-pointer ${
            currentView === 'chat'
              ? 'bg-[#15271a] text-[#4ade80] border border-[#22c55e]/40 shadow-[0_0_15px_rgba(34,197,94,0.2)]'
              : 'text-neutral-400 hover:text-neutral-200'
          }`}
        >
          AI Chat
        ...
        <button
          ...
          className={`px-5 py-2 rounded-full text-xs sm:text-sm font-medium transition-all cursor-pointer ${
            currentView === 'help'
              ? 'bg-[#15271a] text-[#4ade80] border border-[#22c55e]/40'
              : 'text-neutral-400 hover:text-neutral-200'
          }`}
        >
          Help
