...
export const SourceCitation = ({
  ...
  return <button
    ...
    className={`inline-flex items-center gap-1.5 rounded-full font-medium transition-all cursor-pointer border select-none group ${isActive ? "bg-neutral-900 text-white border-neutral-900 shadow-sm ring-1 ring-neutral-900" : "bg-neutral-100 hover:bg-neutral-200/90 text-neutral-800 hover:text-neutral-900 border-neutral-200 hover:border-neutral-300"} ${sizeClasses}`}
  >
